...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_flashcard_progress_group_id'), 'flashcard_progress', ['group_id'], unique=False)
    op.create_index(op.f('ix_flashcard_progress_project_id'), 'flashcard_progress', ['project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_flashcard_progress_project_id'), table_name='flashcard_progress')
    op.drop_index(op.f('ix_flashcard_progress_group_id'), table_name='flashcard_progress')
