...
def print_config_summary():
    ...
    logger.info(
        f"Azure Storage Input Container: {app_config.AZURE_STORAGE_INPUT_CONTAINER_NAME}"
    )
    logger.info(
        f"Azure Storage Output Container: {app_config.AZURE_STORAGE_OUTPUT_CONTAINER_NAME}"
    )
    logger.info("=" * 60)
