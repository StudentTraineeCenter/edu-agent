# PostgreSQL Flexible Server with Serverless Compute (DISABLED)
...
# Enable pgvector extension (DISABLED)
...
# Firewall rule to allow Azure services (DISABLED)
