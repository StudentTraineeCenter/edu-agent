...
class ToolCallDto(BaseModel):
    ...
    input: dict[str, Any] | None = Field(None, description="Input parameters for the tool")
    output: dict[str, Any] | str | None = Field(None, description="Output result from the tool")
...
class ChatMessageDto(BaseModel):
    ...
    tools: list[ToolCallDto] | None = Field(default=None, description="Tool calls made during message generation")
